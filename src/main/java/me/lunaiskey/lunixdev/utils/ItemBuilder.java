...
public class ItemBuilder {
    ...
    public static ItemStack getGoBack() {
        return ItemBuilder.createItem("&aGo Back",Material.ARROW,List.of(ColorUtil.color("&eClick to return!")));
    }

    public static ItemStack getPreviousPage(int page) {
        return ItemBuilder.createItem(ColorUtil.color("&aPrevious Page"),Material.ARROW,List.of(ColorUtil.color("&7Page "+page)));
    }

    public static ItemStack getNextPage(int page) {
        return ItemBuilder.createItem(ColorUtil.color("&aNext Page"),Material.ARROW,List.of(ColorUtil.color("&7Page "+page)));
    }
